...
class Point_cloud_registration
{
  ...
  {
    //std::cout<<"3find_out_incremental_transfrom"<< std::endl;
    ...
    //std::cout << "Before screen_printf" << std::endl;
    screen_printf( "map corner num %d  surf num %d \n", laserCloudCornerFromMapNum, laserCloudSurfFromMapNum );
    // std::cout << "After screen_printf" << std::endl;
    //printf_line;
    ...
    *(m_logger_timer->get_ostream())<< m_timer->toc_string( "Query points for match" ) << std::endl;
    ...
    //printf_line;
    // std::cout << "开始判断" << std::endl;
    // std::cout << "laserCloudCornerFromMapNum: " << laserCloudCornerFromMapNum << std::endl;
    // std::cout << "CORNER_MIN_MAP_NUM: " << CORNER_MIN_MAP_NUM << std::endl;
    // std::cout << "laserCloudSurfFromMapNum: " << laserCloudSurfFromMapNum << std::endl;
    // std::cout << "SURFACE_MIN_MAP_NUM: " << SURFACE_MIN_MAP_NUM << std::endl;
    // std::cout << "m_current_frame_index: " << m_current_frame_index << std::endl;
    // std::cout << "m_mapping_init_accumulate_frames: " << m_mapping_init_accumulate_frames << std::endl;
                                       ...
                                       pcl::PointCloud<PointType>::Ptr laserCloudSurfStack)
  {
    ...
    //g_mutex_omp.lock();
    //std::cout<<"2find_out_incremental_transfrom"<< std::endl;
    pcl::PointCloud<PointType> laser_cloud_corner_from_map =  *in_laser_cloud_corner_from_map;
    pcl::PointCloud<PointType> laser_cloud_surf_from_map =  *in_laser_cloud_surf_from_map;
