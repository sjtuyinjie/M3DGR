...
//         nh.param<std::string>("fileDirectory", fileDirectory, "/tmp/");
//         nh.param<bool>("useCloudRing", useCloudRing, false);

//         nh.param<int>("N_SCAN", N_SCAN, 16);
//         nh.param<int>("Horizon_SCAN", Horizon_SCAN, 1800);
//         nh.param<float>("ang_res_x", ang_res_x, 0.2);
//         nh.param<float>("ang_res_y", ang_res_y, 0.4);
//         nh.param<float>("ang_bottom", ang_bottom, 0.0);
//         nh.param<int>("groundScanInd", groundScanInd, 0);
