...
"""autogenerated by genpy from livox_repub/CustomMsg.msg. Do not edit."""
import codecs
import sys
...
uint8 line              # laser number in lidar"""
  ...
  _slot_types = ['std_msgs/Header','uint64','uint32','uint8','uint8[3]','livox_repub/CustomPoint[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = livox_repub.msg.CustomPoint()
        _x = val1
        start = end
        end += 19
