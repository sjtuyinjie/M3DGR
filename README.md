...
| **Scenario**     | <th colspan="4">**Visual Challenge**</th> |                   | **LiDAR Degeneracy** |                   |                   | **Wheel Slippage** |                   |                   |                   | **GNSS Denial** | **Standard** | **TOTAL** |
|------------------|-------------------------------------------|-------------------|----------------------|-------------------|-------------------|--------------------|-------------------|-------------------|-------------------|-----------------|--------------|-----------|
...
| <th rowspan="2">**Scenario**</th> | <th colspan="4">**Visual Challenge**</th> |                   | **LiDAR Degeneracy** |                   |                   | **Wheel Slippage** |                   |                   |                   | **GNSS Denial** | **Standard** | **TOTAL** |
|----------------------------------|-------------------------------------------|-------------------|----------------------|-------------------|-------------------|--------------------|-------------------|-------------------|-------------------|-----------------|--------------|-----------|
|                                  | Dark  | VI¹  | Dynamic | Occlusion | Corridor | Elevator | WF² | ST³ | Grass | RR⁴ |               |              |           |
|------------------|-------|------|---------|-----------|----------|----------|------|------|-------|------|---------------|--------------|-----------|
| **Number**       | 5     | 4    | 3       | 4         | 2        | 1        | 2    | 2    | 2     | 1    | 2             | 4            | 32        |
